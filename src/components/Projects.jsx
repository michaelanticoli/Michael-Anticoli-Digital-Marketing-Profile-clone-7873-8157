...
const { FiArrowRight, FiMaximize2, FiX, FiBarChart2, FiCheckCircle, FiInfo } = FiIcons;
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {projects.map((project, idx) => (
            ...
            >
              <div 
                className="p-10 rounded-2xl border border-brand-border transition-all duration-500 group-hover:border-brand-accent/30 overflow-hidden"
                style={{ background: `linear-gradient(135deg, ${project.brandColors.bg}, #000)` }}
              >
                {/* Pattern Overlay */}
                <div 
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-3xl font-black text-brand-text font-custom uppercase tracking-tighter mb-4 group-hover:text-brand-accent transition-colors">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex gap-4">
                    {Object.entries(project.metrics).slice(0, 2).map(([key, val]) => (
                      <div key={key} className="px-4 py-2 bg-white/5 border border-white/5 rounded-lg">
        ...
        {selectedProject && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-5xl max-h-[90vh] overflow-y-auto bg-brand-bg border border-brand-border rounded-3xl shadow-2xl relative"
            >
              <button 
              ...
              <div 
                ...
                style={{ background: `linear-gradient(135deg, ${selectedProject.brandColors.bg}, #000)` }}
              >
                <div 
                  className="absolute inset-0 opacity-10 pointer-events-none"
                  style={{
                    backgroundImage: `repeating-linear-gradient(-45deg, ${selectedProject.brandColors.accent} 0px, ${selectedProject.brandColors.accent} 1px, transparent 1px, transparent 20px)`
                  }}
                />
                ...
                <div className="relative z-10 max-w-3xl">
                  ...
                  <h2 className="text-4xl md:text-6xl font-black text-brand-text font-custom uppercase tracking-tighter leading-tight mb-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="p-10 bg-white/[0.02] flex flex-col justify-between">
                  <div className="p-8 border rounded-xl text-center mb-8" style={{ borderColor: `${selectedProject.brandColors.accent}33`, backgroundColor: `${selectedProject.brandColors.accent}08` }}>
                    ...
                    <div className="text-5xl font-black font-mono" style={{ color: selectedProject.brandColors.glow }}>{selectedProject.metrics.CVR}</div>
                    <div className="mt-4 text-[10px] text-brand-muted font-mono tracking-widest uppercase">
                      ENG {selectedProject.metrics.ENG} • CTR {selectedProject.metrics.CTR}
                    </div>
                  </div>
